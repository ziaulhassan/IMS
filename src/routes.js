...
const launch = Loadable({
  loader: () => import('./views/launch/launch'),
  loading: Loading,
});


const fridge = Loadable({
  loader: () => import('./views/electronics/fridge'),
  loading: Loading,
});
const tv = Loadable({
  loader: () => import('./views/electronics/tv'),
  loading: Loading,
});
const fan = Loadable({
  loader: () => import('./views/electronics/fan'),
  loading: Loading,
});
const Cowork = Loadable({
...
const routes = [
  ...
  { path: '/launch', exact: true, name: 'launch', component: launch },
